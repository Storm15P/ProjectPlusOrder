...
public class Jardin extends AppCompatActivity {
    ...
    private int totalJardinPrecio = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        meatRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                Toast.makeText(Jardin.this, "Seleccionado: " + radioButton.getText(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnAtras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Jardin.this, CatalogoActivity.class);
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedMeatId == -1) {
                    Toast.makeText(Jardin.this, "Por favor, selecciona un tipo de carne", Toast.LENGTH_SHORT).show();
                    return;
                }

                int selectedFriesId = friesRadioGroup.getCheckedRadioButtonId();
                if (selectedFriesId == -1) {
                    Toast.makeText(Jardin.this, "Por favor, selecciona un tipo de papas", Toast.LENGTH_SHORT).show();
                    return;
                }

                int selectedQuantity = numberPicker.getValue();
                if (selectedQuantity == 0) {
                    Toast.makeText(Jardin.this, "Por favor, selecciona una cantidad mayor que 0", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                totalJardinPrecio = selectedQuantity * 33900;

                SharedPreferences prefs = getSharedPreferences("selected_items", MODE_PRIVATE);
                SharedPreferences.Editor editor = prefs.edit();

                String itemText = "Jardin - Carne: " + selectedMeat + ", Papas: " + selectedFries + ", Cantidad: " + selectedQuantity + ", Precio: " + (selectedQuantity*33900) + " COP";
                ...
                Intent intent = new Intent(Jardin.this, Lista.class);
                intent.putExtra("totalJardinPrecio", totalJardinPrecio); // Pasar solo el precio total de Jardin
                startActivity(intent);
            }
        });
    }
